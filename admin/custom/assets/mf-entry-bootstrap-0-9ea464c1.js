...
(async () => {
  const __mfHostInit = await __mfImport("./hostInit-Db0YVeh9.js");
  await __mfHostInit.__tla;
  const { initHost } = __mfHostInit;
  await initHost();
  const __mfPendingShares = await __mfImport("./pendingShares-Cjg1dWhT.js").catch(() => undefined);
...
})().then(() => __mfImport("./index-Bxzo3zFo.js"));
