...
(async () => {
  const __mfHostInit = await __mfImport("./hostInit-DL-KZwP9.js");
  await __mfHostInit.__tla;
  const { initHost } = __mfHostInit;
  await initHost();
  const __mfPendingShares = await __mfImport("./pendingShares-Dfc5WAtQ.js").catch(() => undefined);
...
})().then(() => __mfImport("./index-BvE3WZn-.js"));
