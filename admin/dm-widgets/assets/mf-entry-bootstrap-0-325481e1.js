...
(async () => {
  const __mfHostInit = await __mfImport("./hostInit-B9_i2Qc_.js");
  await __mfHostInit.__tla;
  const { initHost } = __mfHostInit;
  await initHost();
  const __mfPendingShares = await __mfImport("./pendingShares-ChnRvWOD.js").catch(() => undefined);
...
})().then(() => __mfImport("./index-DrTUz4Il.js"));
