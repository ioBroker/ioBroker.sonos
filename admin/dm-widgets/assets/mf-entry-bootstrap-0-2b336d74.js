...
(async () => {
  const __mfHostInit = await __mfImport("./hostInit-CfQEOxLs.js");
  await __mfHostInit.__tla;
  const { initHost } = __mfHostInit;
  await initHost();
  const __mfPendingShares = await __mfImport("./pendingShares-D1fn7z-f.js").catch(() => undefined);
...
})().then(() => __mfImport("./index-BRiKI0hW.js"));
