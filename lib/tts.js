...
function TTS(adapter, player) {
        ...
        if (this._storedState && !this._restoring) {
            ...
            return new Promise(resolve => {
                ...
                .then(() => {
                    ...
                    return promise
                        .then(() => this._storedState.playbackState === 'PLAYING' && this._player.play())
                        .then(() => {
                            if (fadeInMs) {
                                return new Promise(resolve => {
                        ...
                        .then(() => {
                            ...
                            return this._fadeIn(this._storedState.volume);
                        })
                })
    ...
    this._afterPlayingStopped = function () {
        ...
        if (Date.now() - this._playStopped < 1000) {
            adapter.log.debug('Stop state ignored, right after the play start');
            return;
        }
